            ...
            <div class="container-fluid">
                ...
                <form method="POST" action="{{ route('customer.store') }}" enctype="multipart/form-data">
                    ...
                    <x-adminlte-card title="Data Toko" theme="dark" icon="fas fa-md fa-store-alt">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <x-adminlte-input-file id="ktpInp" label="Foto KTP" name="foto_ktp"
                                    placeholder="Choose a file...">
                                    <x-slot name="prependSlot">
                                        <div class="input-group-text bg-lightblue">
                                            <i class="fas fa-upload"></i>
                            ...
                            <div class="col-md-6">
                                <img id="foto_ktp" src="{{asset('storage/ktp/'. 'ktp.png')}}" alt="Foto KTP"
                                    class="rounded mx-auto d-block mt-2" width="200px">
                            </div>
                        </div>
                    </x-adminlte-card>
...
<script type="text/javascript">
    ...
    // ktp
    ktpInp.onchange = evt => {
                const [file] = ktpInp.files
                if (file) {
                    foto_ktp.src = URL.createObjectURL(file)
                }
    }
